...
class URlClass extends StatelessWidget {
  URlClass(
      {required this.myfunction,required this.myplatformIcon, required this.myplatformSubTitle, required this.myplatformTitle,this.myimageurl});
    ...
    return GestureDetector(
      ...
      child: Column(
        children: [ListTile(
          ...
          trailing: Container(width: 200,height: 200,child: Image(image: NetworkImage("$myimageurl"))),
